/*-------------------------------------------------------
|
|               FEDM_ISCReaderConfig_PRH102.cpp
|
---------------------------------------------------------
...
Function			:	implementation of Access-ID map for OBID i-scan® HF reader ID ISC.PRH102
...
void FEDM_ISCReader::BuildAccessIdMap_PRH102()
{
	m_mapAccessID.clear();
