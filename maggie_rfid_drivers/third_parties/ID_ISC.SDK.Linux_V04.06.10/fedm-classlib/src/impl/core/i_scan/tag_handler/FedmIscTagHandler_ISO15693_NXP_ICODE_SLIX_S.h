/*-------------------------------------------------------
|                                                       |
|	   FedmIscTagHandler_ISO15693_NXP_ICODE_SLIX_S.h    |
|                                                       |
---------------------------------------------------------
...
#if !defined(_FEDM_ISC_TAG_HANDLER_ISO15693_NXP_ICODE_SLIX_S_H_INCLUDED_)
#define _FEDM_ISC_TAG_HANDLER_ISO15693_NXP_ICODE_SLIX_S_H_INCLUDED_
...
class _FEDM_ISC_CORE_EXT_CLASS FedmIscTagHandler_ISO15693_NXP_ICODE_SLIX_S : public FedmIscTagHandler_ISO15693_NXP_ICODE_SLI_S
{
public:
...
protected:
	// constructor
	FedmIscTagHandler_ISO15693_NXP_ICODE_SLIX_S(FEDM_ISCReader* pReader, FEDM_ISOTabItem* pTabItem);
	// 2. constructor
	FedmIscTagHandler_ISO15693_NXP_ICODE_SLIX_S(FEDM_ISCReader* pReader, unsigned int uiTagHandlerType, FEDM_ISOTabItem* pTabItem);
	// destructor
	virtual ~FedmIscTagHandler_ISO15693_NXP_ICODE_SLIX_S();
...
#endif // !defined(_FEDM_ISC_TAG_HANDLER_ISO15693_NXP_ICODE_SLIX_S_H_INCLUDED_)
