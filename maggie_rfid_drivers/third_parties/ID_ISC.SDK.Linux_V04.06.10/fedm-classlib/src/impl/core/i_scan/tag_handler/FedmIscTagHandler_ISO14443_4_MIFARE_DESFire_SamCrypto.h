...
#if !defined(_FEDM_ISC_TAG_HANDLER_ISO14443_4_MIFARE_DESFIRE_SAM_CRYPTO_H_INCLUDED_)
#define _FEDM_ISC_TAG_HANDLER_ISO14443_4_MIFARE_DESFIRE_SAM_CRYPTO_H_INCLUDED_
...
/// This class implements the communication with [0xC3] Reader commands and internal SAM crypto commands.<br>
...
public:
	...
	/// @brief Return of last Error Code
	///
	/// @return Error Code
	///
	/// <b>Description</b><br>
	...
	/// @brief Adjust timeout for Reader internal communication
	///
	/// @param[in] uiTimeout Timeout value in steps of 100 ms
	///
	/// <b>Description</b><br>
	/// 
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int Authenticate(		unsigned char ucSamSlotNo,
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int ChangeKeySettings(	unsigned char ucSamSlotNo,
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int GetKeySettings(		unsigned char ucSamSlotNo,
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int ChangeKey(			unsigned char ucSamSlotNo,
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int GetKeyVersion(		unsigned char ucSamSlotNo,
							unsigned char ucDESFireKeyNo,
							unsigned char* pucResponseData,
							unsigned int uiResponseBufferLength,
							unsigned int& uiResponseLength );
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int CreateApplication(	unsigned char ucSamSlotNo,
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int DeleteApplication(	unsigned char ucSamSlotNo,
							unsigned char ucPiccLevelFlags,
							unsigned int uiApplicationID );
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int GetApplicationIDs(	unsigned char ucSamSlotNo,
							unsigned char ucPiccLevelFlags,
							unsigned char* pucResponseData,
							unsigned int uiResponseBufferLength,
							unsigned int& uiResponseLength );
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int FreeMemory(			unsigned char ucSamSlotNo,
							unsigned char ucPiccLevelFlags,
							unsigned char* pucResponseData,
							unsigned int uiResponseBufferLength,
							unsigned int& uiResponseLength );
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int GetDFNames(			unsigned char ucSamSlotNo,
							unsigned char ucPiccLevelFlags,
							unsigned char* pucResponseData,
							unsigned int uiResponseBufferLength,
							unsigned int& uiResponseLength );
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int SelectApplication(	unsigned char ucSamSlotNo,
							unsigned char ucPiccLevelFlags,
							unsigned int uiApplicationID );
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int FormatPICC(			unsigned char ucSamSlotNo,
							unsigned char ucPiccLevelFlags );
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int GetVersion(			unsigned char ucSamSlotNo,
							unsigned char ucPiccLevelFlags,
							unsigned char* pucResponseData,
							unsigned int uiResponseBufferLength,
							unsigned int& uiResponseLength );
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int GetCardUID(			unsigned char ucSamSlotNo,
							unsigned char ucPiccLevelFlags,
							unsigned char* pucResponseData,
							unsigned int uiResponseBufferLength,
							unsigned int& uiResponseLength );
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int SetConfiguration(	unsigned char ucSamSlotNo,
							unsigned char ucPiccLevelFlags,
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int ChangeFileSettings(	unsigned char ucSamSlotNo,
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int GetFileIDs(			unsigned char ucSamSlotNo,
							unsigned char ucApplicationLevelFlags,
							unsigned char* pucResponseData,
							unsigned int uiResponseBufferLength,
							unsigned int& uiResponseLength );
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int GetFileSettings(	unsigned char ucSamSlotNo,
							unsigned char ucApplicationLevelFlags,
							unsigned char ucFileNo,
							unsigned char* pucResponseData,
							unsigned int uiResponseBufferLength,
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int CreateStdDataFile(	unsigned char ucSamSlotNo,
							unsigned char ucApplicationLevelFlags,
							unsigned char ucFileNo,
							unsigned int uiISOFileID,
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int CreateBackupDataFile(	unsigned char ucSamSlotNo,
								unsigned char ucApplicationLevelFlags,
								unsigned char ucFileNo,
								unsigned int uiISOFileID,
								unsigned char ucFileCommSettings,
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int CreateValueFile(	unsigned char ucSamSlotNo,
							unsigned char ucApplicationLevelFlags,
							unsigned char ucFileNo,
							unsigned char ucFileCommSettings,
							unsigned char ucFileReadWriteAccessRights,
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int CreateLinearRecordFile(	unsigned char ucSamSlotNo,
								unsigned char ucApplicationLevelFlags,
								unsigned char ucFileNo,
								unsigned int uiISOFileID,
								unsigned char ucFileCommSettings,
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int CreateCyclicRecordFile(	unsigned char ucSamSlotNo,
								unsigned char ucApplicationLevelFlags,
								unsigned char ucFileNo,
								unsigned int uiISOFileID,
								unsigned char ucFileCommSettings,
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int DeleteFile(			unsigned char ucSamSlotNo,
							unsigned char ucApplicationLevelFlags,
							unsigned char ucFileNo );
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int GetISOFileIDs(		unsigned char ucSamSlotNo,
							unsigned char ucApplicationLevelFlags,
							unsigned char* pucResponseData,
							unsigned int uiResponseBufferLength,
							unsigned int& uiResponseLength );
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int ReadStandardData(	unsigned char ucSamSlotNo,
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int WriteStandardData(	unsigned char ucSamSlotNo,
							unsigned char ucDataManipulationFlags,
							unsigned char ucFileNo,
							unsigned char ucFileCommSettings,
							unsigned int uiFileOffset,
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int GetValue(			unsigned char ucSamSlotNo,
							unsigned char ucDataManipulationFlags,
							unsigned char ucFileNo,
							unsigned char ucFileCommSettings,
							unsigned int& uiValue );
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int Credit(				unsigned char ucSamSlotNo,
							unsigned char ucDataManipulationFlags,
							unsigned char ucFileNo,
							unsigned char ucFileCommSettings,
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int Debit(				unsigned char ucSamSlotNo,
							unsigned char ucDataManipulationFlags,
							unsigned char ucFileNo,
							unsigned char ucFileCommSettings,
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int LimitedCredit(		unsigned char ucSamSlotNo,
							unsigned char ucDataManipulationFlags,
							unsigned char ucFileNo,
							unsigned char ucFileCommSettings,
							unsigned int uiCreditValue );
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int WriteRecord(		unsigned char ucSamSlotNo,
							unsigned char ucDataManipulationFlags,
							unsigned char ucFileNo,
							unsigned char ucFileCommSettings,
							unsigned int uiFileOffset,
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int ReadRecords(		unsigned char ucSamSlotNo,
							unsigned char ucDataManipulationFlags,
							unsigned char ucFileNo,
							unsigned char ucFileCommSettings,
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int ClearRecordFile(	unsigned char ucSamSlotNo,
							unsigned char ucDataManipulationFlags,
							unsigned char ucFileNo,
							unsigned char ucFileCommSettings );
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int CommitTransaction(	unsigned char ucSamSlotNo,
							unsigned char ucDataManipulationFlags );
	...
	/// - Product Datasheet for MIFARE DESFire from NXP Semiconductors
	/// - System Manual <i>SAMCrypto Functions</i> from FEIG ELECTRONIC
	int AbortTransaction(	unsigned char ucSamSlotNo,
							unsigned char ucDataManipulationFlags );
...
protected:
	...
	int SetPortTimeout(unsigned int uiTimeout);		// for all port types

	// getting port parameter
	int GetPortTimeout(unsigned int* uiTimeout);	// for all port types
...
#endif // !defined(_FEDM_ISC_TAG_HANDLER_ISO14443_4_MIFARE_DESFIRE_SAM_CRYPTO_H_INCLUDED_)
