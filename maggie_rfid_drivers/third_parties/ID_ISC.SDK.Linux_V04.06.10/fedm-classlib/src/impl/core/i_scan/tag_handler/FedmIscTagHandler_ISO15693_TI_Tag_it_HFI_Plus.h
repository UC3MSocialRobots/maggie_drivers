/*-------------------------------------------------------
|                                                       |
|	   FedmIscTagHandler_ISO15693_TI_Tag_it_HFI_Plus.h  |
|                                                       |
---------------------------------------------------------
...
#if !defined(_FEDM_ISC_TAG_HANDLER_ISO15693_TI_TAG_IT_HFI_PLUS_H_INCLUDED_)
#define _FEDM_ISC_TAG_HANDLER_ISO15693_TI_TAG_IT_HFI_PLUS_H_INCLUDED_
...
class _FEDM_ISC_CORE_EXT_CLASS FedmIscTagHandler_ISO15693_TI_Tag_it_HFI_Plus : public FedmIscTagHandler_ISO15693_TI
{
public:
...
protected:
	// constructor
	FedmIscTagHandler_ISO15693_TI_Tag_it_HFI_Plus(FEDM_ISCReader* pReader, FEDM_ISOTabItem* pTabItem);
	// 2. constructor
	FedmIscTagHandler_ISO15693_TI_Tag_it_HFI_Plus(FEDM_ISCReader* pReader, unsigned int uiTagHandlerType, FEDM_ISOTabItem* pTabItem);
	// destructor
	virtual ~FedmIscTagHandler_ISO15693_TI_Tag_it_HFI_Plus();

};

#endif // #if !defined(_FEDM_NO_TAG_HANDLER_ISO15693)

#endif // !defined(_FEDM_ISC_TAG_HANDLER_ISO15693_TI_TAG_IT_HFI_PLUS_H_INCLUDED_)
