/*-------------------------------------------------------
|
|               FEDM_ISCReaderConfig_LR2000.cpp
|
---------------------------------------------------------
...
Function			:	implementation of Access-ID map for OBID i-scan® HF reader ID ISC.LR2000
...
void FEDM_ISCReader::BuildAccessIdMap_LR2000()
{
	m_mapAccessID.clear();

	FEDM_ISCReader::BuildAccessIdMap_LR2000_Part0();
	FEDM_ISCReader::BuildAccessIdMap_LR2000_Part1();
}


void FEDM_ISCReader::BuildAccessIdMap_LR2000_Part0()
{
	...
	m_mapAccessID.insert(make_pair((string)"AirInterface.Miscellaneous.HF.ICodeUID_ICodeEPC.ErrorHandling.WeakCollision", (string)"03 03 20 07 01 07 01"));
	...
	m_mapAccessID.insert(make_pair((string)"OperatingMode.Miscellaneous.HF.ReaderSynchronization.SwitchCondition", (string)"03 03 18 00 01 06 01"));
...
void FEDM_ISCReader::BuildAccessIdMap_LR2000_Part1()
{
	...
	m_mapAccessID.insert(make_pair((string)"OperatingMode.NotificationMode.EAS.AlarmMode", (string)"03 03 11 10 01 06 01"));
	...
	m_mapAccessID.insert(make_pair((string)"OperatingMode.NotificationMode.GatePeopleCounter.Transmission.Destination.IPv4.IPAddress", (string)"03 03 46 00 04 00 00"));
	m_mapAccessID.insert(make_pair((string)"OperatingMode.NotificationMode.GatePeopleCounter.Transmission.Destination.PortNumber", (string)"03 03 46 04 02 00 00"));
	...
	m_mapAccessID.insert(make_pair((string)"Transponder.Driver.HF.EPC_Class1Gen2", (string)"03 03 03 00 01 01 01"));
	...
	m_mapAccessID.insert(make_pair((string)"Transponder.Driver.HF.Microchip_MCRF45x", (string)"03 03 03 00 01 04 01"));
	...
	m_mapAccessID.insert(make_pair((string)"Transponder.HF.EPC_Class1Gen2.Anticollision.Session", (string)"03 03 05 10 01 00 02"));
	...
	m_mapAccessID.insert(make_pair((string)"Transponder.HF.ISO_15693.Miscellaneous.CommandBreak", (string)"03 03 04 07 01 00 02"));
