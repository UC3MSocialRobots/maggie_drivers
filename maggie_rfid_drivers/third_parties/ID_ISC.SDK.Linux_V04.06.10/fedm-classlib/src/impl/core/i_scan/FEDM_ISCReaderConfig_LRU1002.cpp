/*-------------------------------------------------------
|
|               FEDM_ISCReaderConfig_LRU1002.cpp
|
---------------------------------------------------------
...
Function			:	implementation of Access-ID map for OBID i-scan® UHF reader ID ISC.LRU1002
...
void FEDM_ISCReader::BuildAccessIdMap_LRU1002()
{
	m_mapAccessID.clear();

	FEDM_ISCReader::BuildAccessIdMap_LRU1002_Part0();
	FEDM_ISCReader::BuildAccessIdMap_LRU1002_Part1();
}


void FEDM_ISCReader::BuildAccessIdMap_LRU1002_Part0()
{
...
void FEDM_ISCReader::BuildAccessIdMap_LRU1002_Part1()
{
