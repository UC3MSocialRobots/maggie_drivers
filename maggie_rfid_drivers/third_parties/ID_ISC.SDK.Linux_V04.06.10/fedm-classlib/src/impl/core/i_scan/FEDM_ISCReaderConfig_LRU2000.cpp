/*-------------------------------------------------------
|
|               FEDM_ISCReaderConfig_LRU2000.cpp
|
---------------------------------------------------------
...
Function			:	implementation of Access-ID map for OBID i-scan® UHF reader ID ISC.LRU2000
...
void FEDM_ISCReader::BuildAccessIdMap_LRU2000()
{
	m_mapAccessID.clear();

	FEDM_ISCReader::BuildAccessIdMap_LRU2000_Part0();
	FEDM_ISCReader::BuildAccessIdMap_LRU2000_Part1();
}


void FEDM_ISCReader::BuildAccessIdMap_LRU2000_Part0()
{
	...
	m_mapAccessID.insert(make_pair((string)"AirInterface.Region.UHF.Korea.Channel.LowerChannel", (string)"03 03 03 09 01 00 06"));
	m_mapAccessID.insert(make_pair((string)"AirInterface.Region.UHF.Korea.Channel.UpperChannel", (string)"03 03 03 08 01 00 06"));
	...
	m_mapAccessID.insert(make_pair((string)"DigitalIO.Relay.No4.IdleFlashMode", (string)"03 03 02 03 01 02 02"));
	m_mapAccessID.insert(make_pair((string)"DigitalIO.Relay.No4.IdleMode", (string)"03 03 02 01 01 02 02"));
	m_mapAccessID.insert(make_pair((string)"DigitalIO.Relay.No4.ReadEventActivation.AntennaNo", (string)"03 03 09 10 01 00 00"));
	m_mapAccessID.insert(make_pair((string)"DigitalIO.Relay.No4.SettlingTime", (string)"03 03 02 13 01 00 00"));
	m_mapAccessID.insert(make_pair((string)"HostInterface.DataClock.Format", (string)"03 03 01 11 01 03 03"));
	m_mapAccessID.insert(make_pair((string)"HostInterface.Enable_Discovery", (string)"03 03 01 12 01 06 01"));
...
void FEDM_ISCReader::BuildAccessIdMap_LRU2000_Part1()
{
	...
	m_mapAccessID.insert(make_pair((string)"OperatingMode.NotificationMode.Transmission.DataSetsLimit", (string)"03 03 49 02 01 00 00"));
