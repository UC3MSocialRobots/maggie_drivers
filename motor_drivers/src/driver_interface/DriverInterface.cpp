...
void DriverInterface::printConfiguration () const{
    cout << endl;
    cout << "-- Driver Configuration --" << endl;
    cout << "Driver Configuration File: " << getConfigFile() << endl;
    cout << "Driver Name: " << getDriverName() << endl;
    cout << "Driver Type: " << getDriverType() << endl;
    cout << "Driver ID: " << getDriverID() << endl;

    cout << "Encoder pulses revolution: " << getEncoderPulsesPerRevolution() << endl;
    cout << "Driver Multiplication Factor: " << getDriverMultiplicationFactor() << endl;
    cout << "Reduction Factor: " << getReductionFactor() << endl;
    cout << "Pulses per revolution: " << getPulsesPerRevolution() << endl;
...
void DriverInterface::printStatus () const{
    ...
    cout << "Driver is enabled: " << boolToString(this->isEnabled()) <<endl;;
