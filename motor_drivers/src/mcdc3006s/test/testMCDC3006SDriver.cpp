...
void printMenu(){
    ...
    cout <<  "[ma], [maxacc] : Set Maximum Acceleration" << endl;
    cout <<  "[md], [maxdec] : Set Maximum Deceleration" << endl;
    cout <<  "[clc],[curlimc] : Set Continuous Current Limit" << endl;
    cout <<  "[clp],[curlimp] : Set Peak Current Limit" << endl;
    // Movements
