...
IRTRANSDLL_API NETWORKSTATUS *LearnRawIRCode (SOCKET serv, char rem[],char com[],unsigned short timeout);
IRTRANSDLL_API NETWORKSTATUS *LearnIRCodeEx (SOCKET serv, char rem[],char com[],unsigned short timeout,byte ir_timeout);
IRTRANSDLL_API NETWORKSTATUS *LearnRawIRCodeEx (SOCKET serv, char rem[],char com[],unsigned short timeout,byte ir_timeout);
