/*-------------------------------------------------------
|
|               FEDM_ISCReaderConfig_LRU1000.cpp
|
---------------------------------------------------------
...
Function			:	implementation of Access-ID map for OBID i-scan® UHF reader ID ISC.LRU1000
...
void FEDM_ISCReader::BuildAccessIdMap_LRU1000()
{
	m_mapAccessID.clear();

	FEDM_ISCReader::BuildAccessIdMap_LRU1000_Part0();
	FEDM_ISCReader::BuildAccessIdMap_LRU1000_Part1();
}


void FEDM_ISCReader::BuildAccessIdMap_LRU1000_Part0()
{
	...
	m_mapAccessID.insert(make_pair((string)"AirInterface.Antenna.UHF.Miscellaneous.Gain", (string)"03 03 20 08 01 00 00"));
	...
	m_mapAccessID.insert(make_pair((string)"AirInterface.Multiplexer.UHF.Internal.Antenna.No3.ActiveTime", (string)"03 03 15 06 02 00 00"));
	m_mapAccessID.insert(make_pair((string)"AirInterface.Multiplexer.UHF.Internal.Antenna.No4.ActiveTime", (string)"03 03 15 08 02 00 00"));
	m_mapAccessID.insert(make_pair((string)"AirInterface.Multiplexer.UHF.Internal.NoOfAntennas", (string)"03 03 15 01 01 00 03"));
	m_mapAccessID.insert(make_pair((string)"AirInterface.Multiplexer.UHF.Internal.SwitchCondition", (string)"03 03 15 00 01 01 01"));
	m_mapAccessID.insert(make_pair((string)"AirInterface.Region.UHF.EU.Channel.EN300220.Disable_869MHz_FallbackChannel", (string)"03 03 03 06 01 07 01"));
	m_mapAccessID.insert(make_pair((string)"AirInterface.Region.UHF.EU.Channel.EN302208_with_LBT.Enable_865MHz1", (string)"03 03 03 07 01 00 01"));
	m_mapAccessID.insert(make_pair((string)"AirInterface.Region.UHF.EU.Channel.EN302208_with_LBT.Enable_865MHz3", (string)"03 03 03 07 01 01 01"));
	m_mapAccessID.insert(make_pair((string)"AirInterface.Region.UHF.EU.Channel.EN302208_with_LBT.Enable_865MHz5", (string)"03 03 03 07 01 02 01"));
	m_mapAccessID.insert(make_pair((string)"AirInterface.Region.UHF.EU.Channel.EN302208_with_LBT.Enable_865MHz7", (string)"03 03 03 07 01 03 01"));
	m_mapAccessID.insert(make_pair((string)"AirInterface.Region.UHF.EU.Channel.EN302208_with_LBT.Enable_865MHz9", (string)"03 03 03 07 01 04 01"));
	m_mapAccessID.insert(make_pair((string)"AirInterface.Region.UHF.EU.Channel.EN302208_with_LBT.Enable_866MHz1", (string)"03 03 03 07 01 05 01"));
	m_mapAccessID.insert(make_pair((string)"AirInterface.Region.UHF.EU.Channel.EN302208_with_LBT.Enable_866MHz3", (string)"03 03 03 07 01 06 01"));
	m_mapAccessID.insert(make_pair((string)"AirInterface.Region.UHF.EU.Channel.EN302208_with_LBT.Enable_866MHz5", (string)"03 03 03 07 01 07 01"));
	m_mapAccessID.insert(make_pair((string)"AirInterface.Region.UHF.EU.Channel.EN302208_with_LBT.Enable_866MHz7", (string)"03 03 03 06 01 00 01"));
	m_mapAccessID.insert(make_pair((string)"AirInterface.Region.UHF.EU.Channel.EN302208_with_LBT.Enable_866MHz9", (string)"03 03 03 06 01 01 01"));
	m_mapAccessID.insert(make_pair((string)"AirInterface.Region.UHF.EU.Channel.EN302208_with_LBT.Enable_867MHz1", (string)"03 03 03 06 01 02 01"));
	m_mapAccessID.insert(make_pair((string)"AirInterface.Region.UHF.EU.Channel.EN302208_with_LBT.Enable_867MHz3", (string)"03 03 03 06 01 03 01"));
	m_mapAccessID.insert(make_pair((string)"AirInterface.Region.UHF.EU.Channel.EN302208_with_LBT.Enable_867MHz5", (string)"03 03 03 06 01 04 01"));
	m_mapAccessID.insert(make_pair((string)"AirInterface.Region.UHF.EU.Channel.EN302208_with_LBT.Enable_867MHz7", (string)"03 03 03 06 01 05 01"));
	m_mapAccessID.insert(make_pair((string)"AirInterface.Region.UHF.EU.Channel.EN302208_with_LBT.Enable_867MHz9", (string)"03 03 03 06 01 06 01"));
	...
	m_mapAccessID.insert(make_pair((string)"AirInterface.Region.UHF.Korea.Channel.ChannelAllocationMode", (string)"03 03 03 08 01 06 02"));
	...
	m_mapAccessID.insert(make_pair((string)"HostInterface.Interfaces", (string)"03 03 01 12 01 00 04"));
	...
	m_mapAccessID.insert(make_pair((string)"HostInterface.LAN.LocalHost.PortNumber", (string)"03 03 40 10 02 00 00"));
...
void FEDM_ISCReader::BuildAccessIdMap_LRU1000_Part1()
{
	...
	m_mapAccessID.insert(make_pair((string)"Transponder.Driver.UHF.EM4222_EM4444", (string)"03 03 03 01 01 03 01"));
	m_mapAccessID.insert(make_pair((string)"Transponder.Driver.UHF.EPC_Class1Gen1", (string)"03 03 03 00 01 01 01"));
	m_mapAccessID.insert(make_pair((string)"Transponder.Driver.UHF.EPC_Class1Gen2", (string)"03 03 03 01 01 04 01"));
	m_mapAccessID.insert(make_pair((string)"Transponder.Driver.UHF.ISO_18000_6_B", (string)"03 03 03 01 01 01 01"));
	...
	m_mapAccessID.insert(make_pair((string)"Transponder.UHF.EPC_Class1Gen1.LinkRate.ReturnLinkBitrate", (string)"03 03 04 10 01 00 01"));
	m_mapAccessID.insert(make_pair((string)"Transponder.UHF.EPC_Class1Gen1.LinkRate.UidLength", (string)"03 03 04 10 01 01 02"));
	m_mapAccessID.insert(make_pair((string)"Transponder.UHF.EPC_Class1Gen1.SelectionMask.FirstBit", (string)"03 03 21 01 01 00 00"));
	m_mapAccessID.insert(make_pair((string)"Transponder.UHF.EPC_Class1Gen1.SelectionMask.Mask", (string)"03 03 21 02 12 00 00"));
	m_mapAccessID.insert(make_pair((string)"Transponder.UHF.EPC_Class1Gen1.SelectionMask.MaskLength", (string)"03 03 21 00 01 00 00"));
	...
	m_mapAccessID.insert(make_pair((string)"Transponder.UHF.ISO_18000_6_B.LinkRate.ForwardLinkBitrate", (string)"03 03 04 02 01 00 03"));
	m_mapAccessID.insert(make_pair((string)"Transponder.UHF.ISO_18000_6_B.LinkRate.ForwardLinkModulation", (string)"03 03 04 02 01 04 03"));
	m_mapAccessID.insert(make_pair((string)"Transponder.UHF.ISO_18000_6_B.LinkRate.ReturnLinkBitrate", (string)"03 03 04 03 01 00 04"));
	m_mapAccessID.insert(make_pair((string)"Transponder.UHF.ISO_18000_6_B.SelectionMask.FirstByte", (string)"03 03 29 02 01 00 00"));
	m_mapAccessID.insert(make_pair((string)"Transponder.UHF.ISO_18000_6_B.SelectionMask.Mask", (string)"03 03 29 03 08 00 00"));
	m_mapAccessID.insert(make_pair((string)"Transponder.UHF.ISO_18000_6_B.SelectionMask.MaskLength", (string)"03 03 29 00 01 00 00"));
	m_mapAccessID.insert(make_pair((string)"Transponder.UHF.ISO_18000_6_B.SelectionMask.Operation", (string)"03 03 29 01 01 00 00"));
}
