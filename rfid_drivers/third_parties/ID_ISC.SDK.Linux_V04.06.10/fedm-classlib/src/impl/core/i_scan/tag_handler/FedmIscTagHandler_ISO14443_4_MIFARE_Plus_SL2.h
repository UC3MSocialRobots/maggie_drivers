/*-------------------------------------------------------
|                                                       |
|      FedmIscTagHandler_ISO14443_4_MIFARE_Plus_SL2.h   |
|                                                       |
---------------------------------------------------------
...
Function			:	class for OBID® classic-pro transponder ISO14443-4 MIFARE Plus in Security Level 2
...
#if !defined(_FEDM_ISC_TAG_HANDLER_ISO14443_4_MIFARE_PLUS_SL2_H_INCLUDED_)
#define _FEDM_ISC_TAG_HANDLER_ISO14443_4_MIFARE_PLUS_SL2_H_INCLUDED_
...
class _FEDM_ISC_CORE_EXT_CLASS FedmIscTagHandler_ISO14443_4_MIFARE_Plus_SL2 : public FedmIscTagHandler_ISO14443_4_MIFARE_Plus
{
public:
...
protected:
	// constructor
	FedmIscTagHandler_ISO14443_4_MIFARE_Plus_SL2(FEDM_ISCReader* pReader, FEDM_ISOTabItem* pTabItem);
	// 2. constructor
	FedmIscTagHandler_ISO14443_4_MIFARE_Plus_SL2(FEDM_ISCReader* pReader, unsigned int uiTagHandlerType, FEDM_ISOTabItem* pTabItem);
	// destructor
	virtual ~FedmIscTagHandler_ISO14443_4_MIFARE_Plus_SL2();

};

#endif // #if !defined(_FEDM_NO_TAG_HANDLER_ISO14443)

#endif // !defined(_FEDM_ISC_TAG_HANDLER_ISO14443_4_MIFARE_PLUS_SL2_H_INCLUDED_)
