/*-------------------------------------------------------
|                                                       |
|	   FedmIscTagHandler_ISO15693_Fujitsu.h             |
|                                                       |
---------------------------------------------------------
...
#if !defined(_FEDM_ISC_TAG_HANDLER_ISO15693_FUJITSU_H_INCLUDED_)
#define _FEDM_ISC_TAG_HANDLER_ISO15693_FUJITSU_H_INCLUDED_
...
//####################################################################
// class FedmIscTagHandler_ISO15693_Fujitsu
...
class _FEDM_ISC_CORE_EXT_CLASS FedmIscTagHandler_ISO15693_Fujitsu : public FedmIscTagHandler_ISO15693
{
public:
...
protected:
	// constructor
	FedmIscTagHandler_ISO15693_Fujitsu(FEDM_ISCReader* pReader, FEDM_ISOTabItem* pTabItem);
	// 2. constructor
	FedmIscTagHandler_ISO15693_Fujitsu(FEDM_ISCReader* pReader, unsigned int uiTagHandlerType, FEDM_ISOTabItem* pTabItem);
	// destructor
	virtual ~FedmIscTagHandler_ISO15693_Fujitsu();

};

#endif // #if !defined(_FEDM_NO_TAG_HANDLER_ISO15693)

#endif // !defined(_FEDM_ISC_TAG_HANDLER_ISO15693_FUJITSU_H_INCLUDED_)
