/*-------------------------------------------------------
|
|               FEDM_ISCReaderConfig_CPR44.cpp
|
---------------------------------------------------------
...
Function			:	implementation of Access-ID map for OBID® classic-pro reader ID CPR44.xx
...
void FEDM_ISCReader::BuildAccessIdMap_CPR44()
{
	m_mapAccessID.clear();
	...
	m_mapAccessID.insert(make_pair((string)"DigitalIO.Output.No1.OfflineState", (string)"03 03 02 08 01 00 02"));
	m_mapAccessID.insert(make_pair((string)"DigitalIO.Output.No1.OnlineState", (string)"03 03 02 03 01 00 02"));
	m_mapAccessID.insert(make_pair((string)"DigitalIO.Output.No1.TagDetectState", (string)"03 03 02 11 01 00 02"));
	m_mapAccessID.insert(make_pair((string)"DigitalIO.Output.No2.OfflineState", (string)"03 03 02 08 01 02 02"));
	m_mapAccessID.insert(make_pair((string)"DigitalIO.Output.No2.OnlineState", (string)"03 03 02 03 01 02 02"));
	m_mapAccessID.insert(make_pair((string)"DigitalIO.Output.No2.TagDetectState", (string)"03 03 02 11 01 02 02"));
	m_mapAccessID.insert(make_pair((string)"DigitalIO.Output.No3.OfflineState", (string)"03 03 02 08 01 04 02"));
	m_mapAccessID.insert(make_pair((string)"DigitalIO.Output.No3.OnlineState", (string)"03 03 02 03 01 04 02"));
	m_mapAccessID.insert(make_pair((string)"DigitalIO.Output.No3.TagDetectState", (string)"03 03 02 11 01 04 02"));
	m_mapAccessID.insert(make_pair((string)"DigitalIO.Output.OfflineDelay", (string)"03 03 02 09 01 00 00"));
	m_mapAccessID.insert(make_pair((string)"DigitalIO.Output.TagDetectActiveTime", (string)"03 03 02 12 01 00 00"));
