/*-------------------------------------------------------
|
|               FEDM_ISCReaderConfig_CPR30.cpp
|
---------------------------------------------------------
...
void FEDM_ISCReader::BuildAccessIdMap_CPR30()
{
	m_mapAccessID.clear();
	...
	m_mapAccessID.insert(make_pair((string)"DigitalIO.Signaler.LED.Yellow.OfflineState", (string)"03 03 02 08 01 02 02"));
	m_mapAccessID.insert(make_pair((string)"DigitalIO.Signaler.LED.Yellow.OnlineState", (string)"03 03 02 03 01 02 02"));
	m_mapAccessID.insert(make_pair((string)"DigitalIO.Signaler.LED.Yellow.TagDetectState", (string)"03 03 02 11 01 02 02"));
