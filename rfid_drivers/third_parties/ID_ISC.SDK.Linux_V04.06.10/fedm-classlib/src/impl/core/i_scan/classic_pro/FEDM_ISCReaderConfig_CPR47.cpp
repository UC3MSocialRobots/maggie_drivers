/*-------------------------------------------------------
|
|               FEDM_ISCReaderConfig_CPR47.cpp
|
---------------------------------------------------------
...
Function			:	implementation of Access-ID map for OBID® classic-pro reader ID CPR47.xx
...
void FEDM_ISCReader::BuildAccessIdMap_CPR47()
{
	m_mapAccessID.clear();
	...
	m_mapAccessID.insert(make_pair((string)"HostInterface.IrDA.AccessPassword.Enable", (string)"03 03 16 11 01 00 01"));
	m_mapAccessID.insert(make_pair((string)"HostInterface.IrDA.AccessPassword.Password", (string)"03 03 16 07 04 00 00"));
	...
	m_mapAccessID.insert(make_pair((string)"HostInterface.MultiDropBus.DeviceAddress", (string)"03 03 16 04 01 02 01"));
	...
	m_mapAccessID.insert(make_pair((string)"OperatingMode.Payment.Interface", (string)"03 03 16 12 01 00 00"));
	...
	m_mapAccessID.insert(make_pair((string)"OperatingMode.Payment.girogo.Functions", (string)"03 03 16 13 01 00 00"));
	...
	m_mapAccessID.insert(make_pair((string)"OperatingMode.Payment.girogo.SmartCard.Enable", (string)"03 03 16 06 01 00 01"));
