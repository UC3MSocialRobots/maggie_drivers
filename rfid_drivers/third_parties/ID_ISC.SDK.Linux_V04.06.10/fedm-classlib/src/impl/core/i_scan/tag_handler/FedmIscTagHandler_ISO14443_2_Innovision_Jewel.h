/*-------------------------------------------------------
|                                                       |
|      FedmIscTagHandler_ISO14443_2_Innovision_Jewel.h  |
|                                                       |
---------------------------------------------------------
...
#if !defined(_FEDM_ISC_TAG_HANDLER_ISO14443_2_INNOVISION_JEWEL_H_INCLUDED_)
#define _FEDM_ISC_TAG_HANDLER_ISO14443_2_INNOVISION_JEWEL_H_INCLUDED_
...
class _FEDM_ISC_CORE_EXT_CLASS FedmIscTagHandler_ISO14443_2_Innovision_Jewel : public FedmIscTagHandler_ISO14443_2
{
public:
...
protected:
	// constructor
	FedmIscTagHandler_ISO14443_2_Innovision_Jewel(FEDM_ISCReader* pReader, FEDM_ISOTabItem* pTabItem);
	// 2. constructor
	FedmIscTagHandler_ISO14443_2_Innovision_Jewel(FEDM_ISCReader* pReader, unsigned int uiTagHandlerType, FEDM_ISOTabItem* pTabItem);
	// destructor
	virtual ~FedmIscTagHandler_ISO14443_2_Innovision_Jewel();

};

#endif // #if !defined(_FEDM_NO_TAG_HANDLER_ISO14443)

#endif // !defined(_FEDM_ISC_TAG_HANDLER_ISO14443_2_INNOVISION_JEWEL_H_INCLUDED_)
