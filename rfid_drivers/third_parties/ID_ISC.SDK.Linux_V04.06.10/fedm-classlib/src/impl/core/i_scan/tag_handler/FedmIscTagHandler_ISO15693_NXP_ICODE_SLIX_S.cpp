/*-------------------------------------------------------
|                                                       |
|      FedmIscTagHandler_ISO15693_NXP_ICODE_SLIX_S.cpp  |
|                                                       |
---------------------------------------------------------
...
#include "FedmIscTagHandler_ISO15693_NXP_ICODE_SLIX_S.h"
...
FedmIscTagHandler_ISO15693_NXP_ICODE_SLIX_S::FedmIscTagHandler_ISO15693_NXP_ICODE_SLIX_S(
	FEDM_ISCReader* pReader,
	FEDM_ISOTabItem* pTabItem )
	: FedmIscTagHandler_ISO15693_NXP_ICODE_SLI_S(pReader, FedmIscTagHandler::TYPE_ISO15693_NXP_ICODE_SLIX_S, pTabItem)
{
	m_sTagName = "ISO 15693 : ";
	m_sTagName += FEDM_TabItem::GetISO15693Manufacturer(FEDM_ISC_ISO_MFR_NXP);
	m_sTagName += " I-Code SLIX-S";
}
...
FedmIscTagHandler_ISO15693_NXP_ICODE_SLIX_S::FedmIscTagHandler_ISO15693_NXP_ICODE_SLIX_S(
	...
	FEDM_ISOTabItem* pTabItem )
	: FedmIscTagHandler_ISO15693_NXP_ICODE_SLI_S(pReader, uiTagHandlerType, pTabItem)
{
	m_sTagName = "ISO 15693 : ";
	m_sTagName += FEDM_TabItem::GetISO15693Manufacturer(FEDM_ISC_ISO_MFR_NXP);
	m_sTagName += " I-Code SLIX-S";
...
/*void FedmIscTagHandler_ISO15693_NXP_ICODE_SLIX_S::Init()
{
}*/
...
***************************************************************************/
int FedmIscTagHandler_ISO15693_NXP_ICODE_SLIX_S::PasswordProtectAFI()
{
	int iErr = 0;
