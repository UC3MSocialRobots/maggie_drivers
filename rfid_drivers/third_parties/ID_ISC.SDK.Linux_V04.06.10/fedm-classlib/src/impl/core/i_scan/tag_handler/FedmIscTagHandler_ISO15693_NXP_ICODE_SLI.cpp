...
FedmIscTagHandler_ISO15693_NXP_ICODE_SLI::FedmIscTagHandler_ISO15693_NXP_ICODE_SLI(
	FEDM_ISCReader* pReader,
	FEDM_ISOTabItem* pTabItem )
	: FedmIscTagHandler_ISO15693_NXP(pReader, FedmIscTagHandler::TYPE_ISO15693_NXP_ICODE_SLI, pTabItem)
{
	m_sTagName = "ISO 15693 : ";
	m_sTagName += FEDM_TabItem::GetISO15693Manufacturer(FEDM_ISC_ISO_MFR_NXP);
	m_sTagName += " I-Code SLI";
}
...
FedmIscTagHandler_ISO15693_NXP_ICODE_SLI::FedmIscTagHandler_ISO15693_NXP_ICODE_SLI(
	...
	FEDM_ISOTabItem* pTabItem )
	: FedmIscTagHandler_ISO15693_NXP(pReader, uiTagHandlerType, pTabItem)
{
	m_sTagName = "ISO 15693 : ";
	m_sTagName += FEDM_TabItem::GetISO15693Manufacturer(FEDM_ISC_ISO_MFR_NXP);
	m_sTagName += " I-Code SLI";
...
/*void FedmIscTagHandler_ISO15693_NXP_ICODE_SLI::Init()
{
}*/
...
***************************************************************************/
int FedmIscTagHandler_ISO15693_NXP_ICODE_SLI::SetEAS()
{
	int iErr = 0;
...
/***************************************************************************
  ...
  Return value		:	0				- if tramsmission was successful
						...
						error code (<0)	- if something goes wrong
***************************************************************************/
int FedmIscTagHandler_ISO15693_NXP_ICODE_SLI::ResetEAS()
{
	int iErr = 0;
...
/***************************************************************************
  ...
  Return value		:	0				- if tramsmission was successful
						...
						error code (<0)	- if something goes wrong
***************************************************************************/
int FedmIscTagHandler_ISO15693_NXP_ICODE_SLI::LockEAS()
{
	int iErr = 0;
...
/***************************************************************************
  ...
  Return value		:	0				- if tramsmission was successful
						...
						error code (<0)	- if something goes wrong
***************************************************************************/
int FedmIscTagHandler_ISO15693_NXP_ICODE_SLI::EASAlarm()
{
	int iErr = 0;
