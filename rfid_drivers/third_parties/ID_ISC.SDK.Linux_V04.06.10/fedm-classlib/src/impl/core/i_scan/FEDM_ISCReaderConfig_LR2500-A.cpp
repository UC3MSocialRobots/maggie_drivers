/*-------------------------------------------------------
|
|               FEDM_ISCReaderConfig_LR2500-A.cpp
|
---------------------------------------------------------
...
Function			:	implementation of Access-ID map for OBID i-scan® HF reader ID ISC.LR2500-A
...
void FEDM_ISCReader::BuildAccessIdMap_LR2500_A()
{
	m_mapAccessID.clear();

	FEDM_ISCReader::BuildAccessIdMap_LR2500_A_Part0();
	FEDM_ISCReader::BuildAccessIdMap_LR2500_A_Part1();
	FEDM_ISCReader::BuildAccessIdMap_LR2500_A_Part2();
}


void FEDM_ISCReader::BuildAccessIdMap_LR2500_A_Part0()
{
...
void FEDM_ISCReader::BuildAccessIdMap_LR2500_A_Part1()
{
	...
	m_mapAccessID.insert(make_pair((string)"OperatingMode.NotificationMode.GatePeopleCounter.Transmission.Destination.IPv4.IPAddress", (string)"03 03 86 00 04 00 00"));
	m_mapAccessID.insert(make_pair((string)"OperatingMode.NotificationMode.GatePeopleCounter.Transmission.Destination.PortNumber", (string)"03 03 86 20 02 00 00"));
...
void FEDM_ISCReader::BuildAccessIdMap_LR2500_A_Part2()
{
