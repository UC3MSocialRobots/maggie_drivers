/*-------------------------------------------------------
|                                                       |
|	   FedmIscTagHandler_ISO15693_STM_LRI2K.h           |
|                                                       |
---------------------------------------------------------
...
#if !defined(_FEDM_ISC_TAG_HANDLER_ISO15693_STM_LRI2K_H_INCLUDED_)
#define _FEDM_ISC_TAG_HANDLER_ISO15693_STM_LRI2K_H_INCLUDED_
...
class _FEDM_ISC_CORE_EXT_CLASS FedmIscTagHandler_ISO15693_STM_LRI2K : public FedmIscTagHandler_ISO15693_STM
{
public:
...
protected:
	// constructor
	FedmIscTagHandler_ISO15693_STM_LRI2K(FEDM_ISCReader* pReader, FEDM_ISOTabItem* pTabItem);
	// 2. constructor
	FedmIscTagHandler_ISO15693_STM_LRI2K(FEDM_ISCReader* pReader, unsigned int uiTagHandlerType, FEDM_ISOTabItem* pTabItem);
	// destructor
	virtual ~FedmIscTagHandler_ISO15693_STM_LRI2K();

};

#endif // #if !defined(_FEDM_NO_TAG_HANDLER_ISO15693)

#endif // !defined(_FEDM_ISC_TAG_HANDLER_ISO15693_STM_LRI2K_H_INCLUDED_)
